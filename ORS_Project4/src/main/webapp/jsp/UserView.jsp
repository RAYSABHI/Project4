...
<body>
   ...
   <center>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    <th align="left" > Gender <span style="color: red" size="26">*</span> :</th>
                    <td>
                        <%
    ...
    <tr><th style="padding: 3px"></th></tr>          
                 ...
                 <tr>
                  	<th align="left">Role <span style="color: red" size="26">*</span> :</th>
                  	 <td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" style="width:212px" name="mobileNo" maxlength="10" placeholder="Enter Mobile No" size= "26" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
